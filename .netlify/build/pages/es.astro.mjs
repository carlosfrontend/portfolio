...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Portafolio de Carlos Pulido Desarrollador y Programador Web - P\xE1gina principal.", "description": "Contrata a Carlos Pulido para crear aplicaciones web o m\xF3viles." }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="relative pt-4 w-full desktop:w-8/12 desktop:self-center"> ${renderComponent($$result2, "Header", $$Header, { "id": translateLabels("home.id") })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "className": "pt-10" }, { "default": async ($$result3) => renderTemplate`  ${renderComponent($$result3, "Hero", $$Hero, {})} ` })} ${sections.map((section) => renderTemplate`${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": section.id, "className": "pt-36" }, { "default": async ($$result3) => renderTemplate`${section.name === translateLabels("projects.title") ? renderTemplate`<h3 class="text-3xl flex items-center gap-x-2 pb-14 font-bold  dark:text-lime-300 text-slate-800"> <span> <svg class="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M7 8l-4 4l4 4"></path> <path d="M17 8l4 4l-4 4"></path> <path d="M14 4l-4 16"></path> </svg> </span> ${section.name} </h3>` : section.name === translateLabels("about.title") ? renderTemplate`<h3 class="text-3xl flex items-center gap-x-2 pb-4 font-bold dark:text-lime-300 text-slate-800"> <span> <svg class="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path> <path d="M6 21v-2a4 4 0 0 1 4 -4h4"></path> <path d="M15 19l2 2l4 -4"></path> </svg> </span> ${section.name} </h3>
            <p class="pb-3 text-xl font-normal text-pretty dark:text-white text-gray-700">${translateLabels("about.start")} <i class="dark:text-yellow-200">${translateLabels("about-var")}</i> ${translateLabels("about.define")} <strong class="dark:text-yellow-200">${translateLabels("about.javascript")}</strong>.</p>
        ...
        <p class="pb-3 text-xl font-normal text-pretty dark:text-white text-slate-700"> ${translateLabels("about.mountains")} <strong class="dark:text-yellow-200">${translateLabels("about.hiking")}</strong> ${translateLabels("about.disconnect")} </p>` : renderTemplate`<h3 class="text-3xl flex items-center gap-x-2 pb-4 font-bold dark:text-lime-300 text-slate-800"> <span> <svg class="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-tools"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M3 21h4l13 -13a1.5 1.5 0 0 0 -4 -4l-13 13v4"></path> <path d="M14.5 5.5l4 4"></path> <path d="M12 8l-5 -5l-4 4l5 5"></path> <path d="M7 8l-1.5 1.5"></path> <path d="M16 12l5 5l-4 4l-5 -5"></path> <path d="M16 17l-1.5 1.5"></path> </svg> </span> ${translateLabels("skills.title")} </h3>
            ${renderComponent($$result3, "Skills", $$Skills, {})}`}${section.name === translateLabels("projects.title") && sortedProjects.map(
