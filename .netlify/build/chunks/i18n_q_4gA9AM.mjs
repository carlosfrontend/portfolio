import { A as AstroError, M as MissingLocale, c as createAstro, a as createComponent, m as maybeRenderHead, d as addAttribute, r as renderComponent, b as renderTemplate, e as renderSlot } from './astro/server_BqA62yoT.mjs';
import 'kleur/colors';
import { jsxs, jsx } from 'react/jsx-runtime';
import { u as useTranslations } from './sortProjects_CfUhczUY.mjs';
import 'clsx';
import { appendForwardSlash, joinPaths } from '@astrojs/internal-helpers/path';
import '@astrojs/internal-helpers/remote';
import { $ as $$Image } from './_astro_assets_CodrhjZF.mjs';
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<h1 class="w-full text-4xl dark:text-4xl text-slate-800 dark:text-slate-300 font-bold"> ${translateLabels("hero.greeting")} <strong class="bg-clip-text text-transparent bg-gradient-to-r dark:from-sky-400 dark:to-sky-600 from-slate-800 to-slate-700 text-4xl font-bold">Carlos Pulido</strong> </h1> <h2 class="w-full mx-auto text-pretty font-normal dark:text-white text-gray-800 py-4 text-xl"> <strong class="dark:text-yellow-200 text-slate-700 font-bold">${translateLabels("hero.profession")}</strong> ${translateLabels("hero.location")} </h2> <p class="w-full mx-auto dark:dark:text-white text-gray-800 py-1 text-xl"> ${translateLabels("hero.haveSpent")} <strong class="dark:text-yellow-200/90 text-slate-700 font-bold">${translateLabels("hero.timeOfStudy")}</strong> ${translateLabels("hero.thanks")} <a class="text-slate-800/80  dark:dark:text-blue-300 transition-all duration-300 dark:hover:text-yellow-200 dark:border-b-blue-500 border-b-4 border-b-slate-800/80 hover:border-b-slate-900 dark:hover:border-b-yellow-200/90 hover:text-slate-900" href="https://www.theodinproject.com/" rel="noopener noreferrer" target="_blank">
The Odin Project.</a> </p> <p class="w-full mx-auto dark:text-yellow-500 text-gray-800 py-1 text-xl"> ${translateLabels("hero.optionsText")} </p> <div class="flex w-full flex-col tablet:w-[400px] tablet:gap-6 desktop:w-[400px] justify-start gap-4 pt-6"> <a class="flex w-[200px] h-10 items-center justify-center bg-teal-800 transition-all duration-200 hover:scale-105 hover:ring-4 ease-in-out dark:ring-white ring-slate-950  text-slate-100 text-md font-semibold gap-2 rounded-md"${addAttribute(currentLang === "es" ? "/resume_es.pdf" : "/resume_en.pdf", "href")} target="_blank"><span>${renderComponent($$result, "ResumeIcon", ResumeIcon, {})}</span>${translateLabels("hero.cvButton")}</a> <a class="flex w-[200px] h-10 items-center justify-center bg-blue-800 transition-all duration-200 hover:scale-105 hover:ring-4 ease-in-out  dark:ring-white ring-slate-950 text-slate-100 text-md font-semibold gap-2 rounded-md" href="mailto:carlosfrontend@hotmail.com">${renderComponent($$result, "EmailIcon", EmailIcon, {})}${translateLabels("hero.sendEmail")}</a> ${renderComponent($$result, "ButtonToolTip", null, { "currentLang": Astro2.currentLocale || "es", "client:only": "react", "client:component-hydration": "only", "client:component-path": "/home/carlosfrontend/repos/portfolio/src/components/ButtonToolTip.jsx", "client:component-export": "default" })} </div>`;
